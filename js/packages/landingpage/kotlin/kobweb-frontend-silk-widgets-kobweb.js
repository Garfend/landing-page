(function (factory) {
  ...
  var Companion_instance_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.c3;
  var listStyle = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.o1;
  ...
  var Companion_instance_3 = kotlin_com_varabyte_kobweb_silk_foundation.$_$.t1;
  ...
  var Img = kotlin_org_jetbrains_compose_html_html_core.$_$.o3;
  ...
  var Companion_instance_6 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.d3;
  ...
  function TocVars() {
    ...
    tmp.w3i_1 = StyleVariable(tmp0_defaultFallback, 'silk');
  }
  protoOf(TocVars).q37 = function () {
    return this.w3i_1.h2n(this, BorderColor$factory());
  };
  ...
  function TocStyle$lambda($this$base) {
    _init_properties_Toc_kt__9n5312();
    return padding(textAlign(listStyle(Companion_instance, Companion_instance_0.t2k()), Companion_instance_1.v2j()), get_cssRem(0));
  }
  function TocBorderedVariant$lambda($this$addVariantBase) {
    ...
    return padding(border(tmp, tmp_0, 'solid', TocVars_getInstance().q37().b2n()), get_cssRem(1));
  }
  ...
  function Image(src, modifier, variant, width, height, alt, autoPrefix, ref, $composer, $changed, $default) {
    ...
    $composer_0 = $composer_0.t1a(-316775194);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
    ...
    if (!(($default & 8) === 0))
      ...
      $dirty = $dirty | ($composer_0.t10(width_0._v) ? 2048 : 1024);
    if (!(($default & 16) === 0))
      $dirty = $dirty | 24576;
    else if (($changed & 24576) === 0)
      $dirty = $dirty | ($composer_0.t10(height_0._v) ? 16384 : 8192);
    if (!(($default & 32) === 0))
      $dirty = $dirty | 196608;
    else if (($changed & 196608) === 0)
      $dirty = $dirty | ($composer_0.t10(alt_0._v) ? 131072 : 65536);
    if (!(($default & 64) === 0))
      $dirty = $dirty | 1572864;
    else if (($changed & 1572864) === 0)
      $dirty = $dirty | ($composer_0.w19(autoPrefix_0._v) ? 1048576 : 524288);
    if (!(($default & 128) === 0))
      $dirty = $dirty | 12582912;
    else if (($changed & 12582912) === 0)
      $dirty = $dirty | ((($changed & 16777216) === 0 ? $composer_0.t10(ref_0._v) : $composer_0.v19(ref_0._v)) ? 8388608 : 4194304);
    if (!(($dirty & 4793491) === 4793490) || !$composer_0.v18()) {
      if (!(($default & 2) === 0)) {
      ...
      var tmp_5 = alt_0._v;
      var tmp_6 = toModifier(get_ImageStyle(), [variant_0._v], $composer_0, 6).u2u(modifier_0._v);
      $composer_0.a19(-9330928);
      // Inline function 'androidx.compose.runtime.cache' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.u1f(Image$lambda_1(src, modifier_0, variant_0, width_0, height_0, alt_0, autoPrefix_0, ref_0, $changed, $default));
    }
  }
  ...
  function FitWidthImageVariant$lambda($this$addVariantBase) {
    _init_properties_Image_kt__h9v8mh();
    return objectFit(width(Companion_instance, get_percent(100)), Companion_instance_6.h2m());
  }
  ...
  function Image$lambda_0($width, $height) {
    return function ($this$toAttrs) {
      var tmp;
      if (!($width._v == null)) {
        $this$toAttrs.n27('width', $width._v.toString());
        tmp = Unit_instance;
      }
      var tmp_0;
      if (!($height._v == null)) {
        $this$toAttrs.n27('height', $height._v.toString());
        tmp_0 = Unit_instance;
      }
      return Unit_instance;
    };
  ...
  function LinkVars() {
    ...
    this.x3i_1 = StyleVariable_0('silk');
    this.y3i_1 = StyleVariable_0('silk');
  }
  protoOf(LinkVars).z3i = function () {
    return this.x3i_1.h2n(this, DefaultColor$factory());
  };
  protoOf(LinkVars).a3j = function () {
    return this.y3i_1.h2n(this, VisitedColor$factory());
  };
  ...
  function Link(path, text, modifier, variant, openInternalLinksStrategy, openExternalLinksStrategy, updateHistoryMode, autoPrefix, ref, $composer, $changed, $default) {
    ...
    var ref_0 = {_v: ref};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.t1a(-1604486341);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.t10(path) ? 4 : 2);
    if (!(($default & 2) === 0))
      $dirty = $dirty | 48;
    else if (($changed & 48) === 0)
      $dirty = $dirty | ($composer_0.t10(text_0._v) ? 32 : 16);
    if (!(($default & 4) === 0))
      $dirty = $dirty | 384;
    else if (($changed & 384) === 0)
      $dirty = $dirty | ($composer_0.v19(modifier_0._v) ? 256 : 128);
    if (!(($default & 8) === 0))
      $dirty = $dirty | 3072;
    else if (($changed & 3072) === 0)
      $dirty = $dirty | ($composer_0.t10(variant_0._v) ? 2048 : 1024);
    if (!(($default & 16) === 0))
      $dirty = $dirty | 24576;
    else if (($changed & 24576) === 0)
      $dirty = $dirty | ($composer_0.t10(openInternalLinksStrategy_0._v) ? 16384 : 8192);
    if (!(($default & 32) === 0))
      $dirty = $dirty | 196608;
    else if (($changed & 196608) === 0)
      $dirty = $dirty | ($composer_0.t10(openExternalLinksStrategy_0._v) ? 131072 : 65536);
    if (!(($default & 64) === 0))
      $dirty = $dirty | 1572864;
    else if (($changed & 1572864) === 0)
      $dirty = $dirty | ($composer_0.t10(updateHistoryMode_0._v) ? 1048576 : 524288);
    if (!(($default & 128) === 0))
      $dirty = $dirty | 12582912;
    else if (($changed & 12582912) === 0)
      $dirty = $dirty | ($composer_0.w19(autoPrefix_0._v) ? 8388608 : 4194304);
    if (!(($default & 256) === 0))
      $dirty = $dirty | 100663296;
    else if (($changed & 100663296) === 0)
      $dirty = $dirty | ((($changed & 134217728) === 0 ? $composer_0.t10(ref_0._v) : $composer_0.v19(ref_0._v)) ? 67108864 : 33554432);
    if (!(($dirty & 38347923) === 38347922) || !$composer_0.v18()) {
      if (!(($default & 2) === 0)) {
        text_0._v = null;
      }
      if (!(($default & 4) === 0)) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(-1604486341, $dirty, -1, 'com.varabyte.kobweb.silk.components.navigation.Link (Link.kt:104)');
      }
      ...
      $composer_1.b19();
      Link_0(path, tmp, tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp0, $composer_0, 100663296 | 14 & $dirty | 112 & $dirty >> 3 | 896 & $dirty >> 3 | 7168 & $dirty >> 3 | 57344 & $dirty >> 3 | 458752 & $dirty >> 3 | 3670016 & $dirty >> 3 | 29360128 & $dirty >> 3, 0);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.u1f(Link$lambda_0(path, text_0, modifier_0, variant_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, updateHistoryMode_0, autoPrefix_0, ref_0, $changed, $default));
    }
  }
  function Link_0(path, modifier, variant, openInternalLinksStrategy, openExternalLinksStrategy, updateHistoryMode, autoPrefix, ref, content, $composer, $changed, $default) {
    ...
    var ref_0 = {_v: ref};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.t1a(-102859135);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
    ...
    if (!(($default & 8) === 0))
      ...
      $dirty = $dirty | ($composer_0.t10(openInternalLinksStrategy_0._v) ? 2048 : 1024);
    if (!(($default & 16) === 0))
      $dirty = $dirty | 24576;
    else if (($changed & 24576) === 0)
      $dirty = $dirty | ($composer_0.t10(openExternalLinksStrategy_0._v) ? 16384 : 8192);
    if (!(($default & 32) === 0))
      $dirty = $dirty | 196608;
    else if (($changed & 196608) === 0)
      $dirty = $dirty | ($composer_0.t10(updateHistoryMode_0._v) ? 131072 : 65536);
    if (!(($default & 64) === 0))
      $dirty = $dirty | 1572864;
    else if (($changed & 1572864) === 0)
      $dirty = $dirty | ($composer_0.w19(autoPrefix_0._v) ? 1048576 : 524288);
    ...
    if (!(($default & 256) === 0))
      ...
      $dirty = $dirty | ($composer_0.v19(content) ? 67108864 : 33554432);
    if (!(($dirty & 38347923) === 38347922) || !$composer_0.v18()) {
      if (!(($default & 2) === 0)) {
        modifier_0._v = Companion_instance;
      }
      ...
      if (isTraceInProgress()) {
        traceEventStart(-102859135, $dirty, -1, 'com.varabyte.kobweb.silk.components.navigation.Link (Link.kt:135)');
      }
      var tmp = toAttrs(toModifier(get_LinkStyle(), [variant_0._v], $composer_0, 6).u2u(modifier_0._v));
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.u1f(Link$lambda_2(path, modifier_0, variant_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, updateHistoryMode_0, autoPrefix_0, ref_0, content, $changed, $default));
    }
  }
  function LinkStyle$lambda($this$CssStyle) {
    _init_properties_Link_kt__dm1ox2();
    $this$CssStyle.k31(LinkStyle$lambda$lambda);
    var tmp = get_link($this$CssStyle);
    tmp.p30(LinkStyle$lambda$lambda_0);
    var tmp_0 = get_visited($this$CssStyle);
    tmp_0.p30(LinkStyle$lambda$lambda_1);
    var tmp_1 = get_hover($this$CssStyle);
    tmp_1.p30(LinkStyle$lambda$lambda_2);
    return Unit_instance;
  }
  function LinkStyle$lambda$lambda() {
    _init_properties_Link_kt__dm1ox2();
    return textDecorationLine(Companion_instance, Companion_instance_7.t2k());
  }
  function LinkStyle$lambda$lambda_0() {
    _init_properties_Link_kt__dm1ox2();
    return color(Companion_instance, LinkVars_getInstance().z3i().b2n());
  }
  function LinkStyle$lambda$lambda_1() {
    _init_properties_Link_kt__dm1ox2();
    return color(Companion_instance, LinkVars_getInstance().a3j().b2n());
  }
  function LinkStyle$lambda$lambda_2() {
    _init_properties_Link_kt__dm1ox2();
    return textDecorationLine(Companion_instance, Companion_instance_7.o2n());
  }
  function UndecoratedLinkVariant$lambda($this$addVariant) {
    _init_properties_Link_kt__dm1ox2();
    var tmp = get_hover($this$addVariant);
    tmp.p30(UndecoratedLinkVariant$lambda$lambda);
    return Unit_instance;
  }
  ...
  function UncoloredLinkVariant$lambda($this$addVariant) {
    _init_properties_Link_kt__dm1ox2();
    var colorModifier = color(Companion_instance, get_ColorVar().b2n());
    var tmp = get_link($this$addVariant);
    tmp.p30(UncoloredLinkVariant$lambda$lambda(colorModifier));
    var tmp_0 = get_visited($this$addVariant);
    tmp_0.p30(UncoloredLinkVariant$lambda$lambda_0(colorModifier));
    return Unit_instance;
  }
  ...
  function AlwaysUnderlinedLinkVariant$lambda($this$addVariant) {
    _init_properties_Link_kt__dm1ox2();
    $this$addVariant.k31(AlwaysUnderlinedLinkVariant$lambda$lambda);
    return Unit_instance;
  }
  ...
  function Link$lambda($text, $path) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 3) === 2) || !$composer_0.v18()) {
        if (isTraceInProgress()) {
          traceEventStart(-1758927476, $changed, -1, 'com.varabyte.kobweb.silk.components.navigation.Link.<anonymous> (Link.kt:115)');
        }
  ...
  function Link$lambda_1($ref, $content) {
    return function ($this$Anchor, $composer, $changed) {
      var $composer_0 = $composer;
      if (isTraceInProgress()) {
        traceEventStart(-2021008369, $changed, -1, 'com.varabyte.kobweb.silk.components.navigation.Link.<anonymous> (Link.kt:144)');
      }
  ...
  function initSilkWidgetsKobweb(ctx) {
    ...
    var this_0 = mutableTheme.d2z_1;
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'com.varabyte.kobweb.silk.init.initSilkWidgetsKobweb.<anonymous>' call
    // Inline function 'kotlin.apply' call
    var this_1 = this_0.a36_1;
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'com.varabyte.kobweb.silk.init.initSilkWidgetsKobweb.<anonymous>.<anonymous>' call
    get_link_0(this_1).e3h(Colors_instance.k2w(), Colors_instance.y2w());
    // Inline function 'kotlin.apply' call
    var this_2 = this_0.b36_1;
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'com.varabyte.kobweb.silk.init.initSilkWidgetsKobweb.<anonymous>.<anonymous>' call
    get_link_0(this_2).e3h(Colors_instance.n2w(), Colors_instance.b2x());
    var tmp = get_SilkColorsStyle();
    modifyStyleBase(mutableTheme, tmp, VOID, initSilkWidgetsKobweb$lambda);
    mutableTheme.f2z('silk-image', get_ImageStyle());
    mutableTheme.y33('-fit-width', get_FitWidthImageVariant());
    mutableTheme.f2z('silk-link', get_LinkStyle());
    mutableTheme.y33('-uncolored', get_UncoloredLinkVariant());
    mutableTheme.y33('-undecorated', get_UndecoratedLinkVariant());
    mutableTheme.y33('-always-underlined', get_AlwaysUnderlinedLinkVariant());
    mutableTheme.f2z('silk-toc', get_TocStyle());
    mutableTheme.y33('-bordered', get_TocBorderedVariant());
  }
  function initSilkWidgetsKobweb$lambda($this$modifyStyleBase) {
    var palette = toPalette($this$modifyStyleBase.e32_1);
    return setVariable(setVariable(Companion_instance, LinkVars_getInstance().z3i(), get_link_1(palette).f3h()), LinkVars_getInstance().a3j(), get_link_1(palette).f3j());
  }
  ...
  protoOf(MutableLink).q3h = function (_set____db54di) {
    return this.d3j_1.k36(this, default$factory(), _set____db54di);
  };
  protoOf(MutableLink).f3h = function () {
    return this.d3j_1.h2n(this, default$factory_0());
  };
  protoOf(MutableLink).g3j = function (_set____db54di) {
    return this.e3j_1.k36(this, visited$factory(), _set____db54di);
  };
  protoOf(MutableLink).f3j = function () {
    return this.e3j_1.h2n(this, visited$factory_0());
  };
  protoOf(MutableLink).e3h = function (default_0, visited) {
    this.q3h(default_0);
    this.g3j(visited);
  };
