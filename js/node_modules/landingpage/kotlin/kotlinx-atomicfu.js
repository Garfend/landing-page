(function (factory) {
  ...
  protoOf(AtomicRef).gh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).hh = function () {
  ...
  protoOf(AtomicBoolean).ih = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).hh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).jh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).hh = function () {
    return this.kotlinx$atomicfu$value;
  };
